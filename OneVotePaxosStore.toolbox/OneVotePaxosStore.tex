...
\setboolean{shading}{true}
 ...
 {\MODULE} OneVotePaxosStore}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
In this version (adopted from ``\ensuremath{UniversalPaxosStore.tla}''):
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 - Use \ensuremath{OneVote} and \ensuremath{IntersectingQuorum} together to
 replace the
 Client-restricted config for \ensuremath{Ballot} allocation;
 that is, no \ensuremath{Bals(p)} in this version.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} {\EXTENDS} Integers ,\,
 FiniteSets}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Max ( m ,\, n ) \.{\defeq}
 {\IF} m \.{>} n \.{\THEN} m \.{\ELSE} n}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} {\CONSTANTS}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} Participant
 ,\,\@s{4.1}}%
\@y{\@s{0}%
 the set of partipants
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} Value\@s{34.93}}%
\@y{\@s{0}%
 the set of possible input values for \ensuremath{Participant} to propose
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} None \.{\defeq} {\CHOOSE} b
 \.{:} b \.{\notin} Value}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Quorum \.{\defeq} \{ Q
 \.{\in} {\SUBSET} Participant \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{64.66} Cardinality ( Q )
 \.{*} 2 \.{=} Cardinality ( Participant ) \.{+} 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} {\ASSUME} QuorumAssumption
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Participant}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q1 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} Ballot \.{\defeq} Nat}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} State \.{\defeq} [
 maxBal\@s{4.65} \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{41.61} maxVBal \.{:}
 Ballot \.{\cup} \{ \.{-} 1 \} ,\, maxVVal \.{:} Value \.{\cup} \{ None \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} InitState \.{\defeq} [
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} Message \.{\defeq} [ from
 \.{:} Participant ,\, to \.{:} {\SUBSET} Participant ,\, state \.{:} [
 Participant \.{\rightarrow} State ] ]}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} state ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{state[p][q]}: the state of \ensuremath{q \.{\in} Participant}
 from the view of \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} msgs\@s{9.63}}%
\@y{\@s{0}%
 the set of messages that have been sent
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} vars \.{\defeq} {\langle}
 state ,\, msgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 state \.{\in} [ Participant \.{\rightarrow} [ Participant \.{\rightarrow}
 State ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 msgs \.{\subseteq} Message}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} state
 \.{=} [ p \.{\in} Participant \.{\mapsto} [ q \.{\in} Participant
 \.{\mapsto} InitState ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} msgs
 \.{=} \{ \}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} Prepare ( p ,\, b )
 \.{\defeq}}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} UpdateState ( q ,\, p ,\, pp
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} state \.{'} \.{=} [
 state {\EXCEPT}}%
 ...
 maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{148.83} \.{\THEN} pp .
 maxVVal \.{\ELSE} @ ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{64.71} {\bang} [ q ] [ q
 ] . maxBal \.{=} Max ( @ ,\, pp . maxBal ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{64.71} {\bang} [ q ] [ q
 ] . maxVBal \.{=} {\IF} state [ q ] [ q ] . maxBal \.{\leq} pp . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{148.57} \.{\THEN} pp .
 maxVBal \.{\ELSE} @ ,\,\@s{4.1}}%
\@y{\@s{0}%
 make promise
}%
\@xx{}%
 ...
 ] . maxVVal\@s{0.37} \.{=} {\IF} \.{\lor} state [ q ] [ q ] . maxBal \.{<}
 pp . maxVBal}%
\@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{171.83}}%
\@y{\@s{0}%
 \ensuremath{OneVote
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{160.72} \.{\lor} state [
 q ] [ q ] . maxBal \.{=} pp . maxVBal \.{\land} @ \.{=} None}%
...
\end{lcom}%
 ...
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\land} state [
 p ] [ p ] . maxVBal \.{\neq} b}%
\@y{\@s{0}%
 for \ensuremath{OneVote}; \ensuremath{TODO}: too strong\.{?}
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
 (\ensuremath{i.e}., \ensuremath{state[p][p].maxVBal \.{=} b \.{\implies} v
 \.{=} state[p][p].maxVVal})
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
 (it ensures \ensuremath{\A\, p \.{\in} Participant}, \ensuremath{b \.{\in}
 Ballot} : \ensuremath{Accept(p,\, b,\, \_)} only once)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} \.{\land} \E\, Q
 \.{\in} Quorum \.{:} \A\, q \.{\in} Q \.{:} state [ p ] [ q ] . maxBal \.{=}
 b}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 \A\, q \.{\in} Participant \.{:} state [ p ] [ q ] . maxVBal \.{=} \.{-} 1}%
\@y{\@s{0}%
 free to pick its own value
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{27.51} \.{\lor} \E\, q
 \.{\in} Participant \.{:}}%
\@y{\@s{0}%
 \ensuremath{v} is the value with the highest \ensuremath{maxVBal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{46.82} \.{\land} state [
 p ] [ q ] . maxVVal \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{46.82} \.{\land} \A\, r
 \.{\in} Participant \.{:} state [ p ] [ q ] . maxVBal \.{\geq} state [ p ] [
 r ] . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{16.4} \.{\land} state
...
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}} ChosenP ( p ) \.{\defeq}}%
\@y{\@s{0}%
 the set of values chosen by \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{16.4} \{ v \.{\in} Value
 \.{:} \E\, b \.{\in} Ballot \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{85.11} \E\, Q \.{\in}
 Quorum \.{:} \A\, q \.{\in} Q \.{:} \.{\land} state [ p ] [ q ] . maxVBal
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{202.26} \.{\land} state
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 31 16:36:13 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
