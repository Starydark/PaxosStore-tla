...
\@y{\@s{0}%
 allocate ballots for \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{16.4} \.{\land} Send ( [
 from \.{\mapsto} p ,\, to \.{\mapsto} Participant ,\, state \.{\mapsto}
 state \.{'} [ p ] ] )}%
\@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}} Next \.{\defeq} \E\, p
 \.{\in} Participant \.{:} \.{\lor} OnMessage ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{124.23} \.{\lor} \E\, b
 \.{\in} Ballot \.{:} \.{\lor} Prepare ( p ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{196.61} \.{\lor} \E\, v
 \.{\in} Value \.{:} Accept ( p ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} ChosenP ( p ) \.{\defeq}}%
\@y{\@s{0}%
 the set of values chosen by \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{16.4} \{ v \.{\in} Value
 \.{:} \E\, b \.{\in} Ballot \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{85.11} \E\, Q \.{\in}
 Quorum \.{:} \A\, q \.{\in} Q \.{:} \.{\land} state [ p ] [ q ] . maxVBal
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{202.26} \.{\land} state
 [ p ] [ q ] . maxVVal\@s{0.37} \.{=} v \}}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} chosen \.{\defeq} {\UNION}
 \{ ChosenP ( p ) \.{:} p \.{\in} Participant \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}} Consistency \.{\defeq}
 Cardinality ( chosen ) \.{\leq} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} Consistency}%
\@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 14 16:09:53 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
