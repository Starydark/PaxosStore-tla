...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TPaxosWithVotes}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} TPaxos}%
\@x{ {\VARIABLE} votes}%
\@y{%
 \ensuremath{votes[q]}: the set of votes cast by \ensuremath{q \.{\in}
 Participant
}}%
\@xx{}%
\@x{ varsV \.{\defeq} {\langle} vars ,\, votes {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ InitV \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Init}%
 \@x{\@s{16.4} \.{\land} votes \.{=} [ q \.{\in} Participant \.{\mapsto} \{ \}
 ]}%
\@pvspace{8.0pt}%
\@x{ TypeOKV \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} votes \.{\in} [ Participant \.{\rightarrow} {\SUBSET}
 ( Ballot \.{\times} Value ) ]}%
\@x{\@s{16.4} \.{\land} TypeOK}%
\@x{}\midbar\@xx{}%
\@x{ PrepareV ( p ,\, b ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Prepare ( p ,\, b )}%
\@x{\@s{16.4} \.{\land} votes \.{'} \.{=} votes}%
\@pvspace{8.0pt}%
\@x{ AcceptV ( p ,\, b ,\, v ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{9.89} Accept ( p ,\, b ,\, v )}%
 \@x{\@s{16.4} \.{\land}\@s{9.89} votes \.{'} \.{=} [ votes {\EXCEPT} {\bang}
 [ p ] \.{=} @ \.{\cup} \{ {\langle} b ,\, v {\rangle} \} ]}%
\@y{%
 collecting proposal \ensuremath{{\langle}b,\,v{\rangle}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ OnMessageV ( q ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} OnMessage ( q )}%
 \@x{\@s{16.4} \.{\land} {\IF} state \.{'} [ q ] [ q ] . maxVBal \.{\neq}
 state [ q ] [ q ] . maxVBal}%
\@y{%
 accept
}%
\@xx{}%
 \@x{\@s{35.71} \.{\THEN} votes \.{'} \.{=} [ votes {\EXCEPT} {\bang} [ q ]
 \.{=} @ \.{\cup}\@s{4.1}}%
\@y{%
 collecting proposal
}%
\@xx{}%
 \@x{\@s{139.22} \{ {\langle} state \.{'} [ q ] [ q ] . maxVBal ,\, state
 \.{'} [ q ] [ q ] . maxVVal {\rangle} \} ]}%
\@x{\@s{35.71} \.{\ELSE} {\UNCHANGED} votes}%
\@pvspace{8.0pt}%
\@x{ NextV \.{\defeq} \E\, p \.{\in} Participant \.{:}}%
\@x{\@s{69.31} \.{\lor} OnMessageV ( p )}%
 \@x{\@s{69.31} \.{\lor} \E\, b \.{\in} Ballot \.{:} \.{\lor} PrepareV ( p ,\,
 b )}%
 \@x{\@s{141.70} \.{\lor} \E\, v \.{\in} Value \.{:} AcceptV ( p ,\, b ,\, v
 )}%
\@x{ SpecV\@s{1.08} \.{\defeq} InitV \.{\land} {\Box} [ NextV ]_{ varsV}}%
\@x{}\midbar\@xx{}%
 \@x{ maxBal \.{\defeq} [ p \.{\in} Participant \.{\mapsto} state [ p ] [ p ]
 . maxBal ]}%
 \@x{ V \.{\defeq} {\INSTANCE} Voting {\WITH} Acceptor \.{\leftarrow}
 Participant}%
\@x{\@s{155.41}}%
\@y{%
 \ensuremath{votes \.{\leftarrow} votes}, \ensuremath{maxBal \.{\leftarrow}
 maxBal
}}%
\@xx{}%
\@x{ {\THEOREM} SpecR \.{\implies} V {\bang} Spec}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 21:33:26 \ensuremath{CST} 2019 by \ensuremath{pure\_
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Tue}
 \ensuremath{Aug} 06 20:46:18 \ensuremath{CST} 2019 by \ensuremath{pure\_
}%
\end{cpar}%
\end{lcom}%
\end{document}
