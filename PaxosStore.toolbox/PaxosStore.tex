...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\EXTENDS} Integers ,\,
 FiniteSets}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} Max ( m ,\, n ) \.{\defeq}
 {\IF} m \.{>} n \.{\THEN} m \.{\ELSE} n}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Injective ( f ) \.{\defeq}
 \A\, a ,\, b \.{\in} {\DOMAIN} f \.{:} ( a \.{\neq} b ) \.{\implies} ( f [ a
 ] \.{\neq} f [ b ] )}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\CONSTANTS}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} Participant
 ,\,\@s{4.1}}%
\@y{\@s{0}%
 the set of partipants
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} Value\@s{34.93}}%
\@y{\@s{0}%
 the set of possible input values for \ensuremath{Participant} to propose
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} None \.{\defeq} {\CHOOSE} b
 \.{:} b \.{\notin} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} NP \.{\defeq} Cardinality (
 Participant )}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Quorum \.{\defeq} \{ Q
 \.{\in} {\SUBSET} Participant \.{:} Cardinality ( Q ) \.{*} 2 \.{=} NP \.{+}
 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} {\ASSUME} QuorumAssumption
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Participant}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q1 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} Ballot\@s{4.66} \.{\defeq}
 Nat}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} PIndex \.{\defeq} {\CHOOSE}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} Bals ( p ) \.{\defeq} \{ b
...
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} State \.{\defeq} [
 maxBal\@s{4.65} \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{41.61} maxVBal \.{:}
 Ballot \.{\cup} \{ \.{-} 1 \} ,\, maxVVal \.{:} Value \.{\cup} \{ None \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} InitState \.{\defeq} [
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Message \.{\defeq} [
 type\@s{2.69} \.{:} \{\@w{Prepare} ,\,\@w{Accept} ,\,\@w{ACK} \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{58.47} from \.{:}
 Participant ,\, to \.{:} {\SUBSET} Participant ,\,}%
\@y{\@s{0}%
 \ensuremath{TODO}: remove ``to''
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{55.69} state\@s{2.41}
 \.{:} [ Participant \.{\rightarrow} State ] ]}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} state ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{state[p][q]}: the state of \ensuremath{q \.{\in} Participant}
 from the view of \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} msgs\@s{9.63}}%
\@y{\@s{0}%
 the set of messages that have been sent
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} vars \.{\defeq} {\langle}
 state ,\, msgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 state \.{\in} [ Participant \.{\rightarrow} [ Participant \.{\rightarrow}
 State ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 msgs \.{\subseteq} Message}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} state
...
\@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} OnMessage ( q ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \E\, m \.{\in} msgs
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{27.72} \.{\land} m . type
 \.{=}\@w{ACK} \.{\implies} m . to \.{=} \{ q \}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{27.72} \.{\land} \.{\LET}
 p \.{\defeq} m . from}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{38.83} \.{\IN}
 UpdateState ( q ,\, p ,\, m . state [ p ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{27.72} \.{\land} {\IF}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{50.98} \.{\lor} m . state
 [ q ] . maxVBal \.{<} state \.{'} [ q ] [ q ] . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{38.83} \.{\THEN} Send ( [
 type \.{\mapsto}\@w{ACK} ,\, from \.{\mapsto} q ,\, to \.{\mapsto} \{ m .
 from \} ,\, state \.{\mapsto} state \.{'} [ q ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{38.83} \.{\ELSE}
 {\UNCHANGED} msgs}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} Accept ( p ,\, b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} \.{\land} {\lnot}
 \E\, m \.{\in} msgs \.{:}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{41.39} m . type
 \.{=}\@w{Accept} \.{\land} m . state [ p ] . maxBal \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land} b
 \.{\in} Bals ( p )\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{TODO}: delete it\.{?} to break ``client-restricted config''\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\land} \E\, Q
 \.{\in} Quorum \.{:} \A\, q \.{\in} Q \.{:} state [ p ] [ q ] . maxBal \.{=}
 b}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 \A\, q \.{\in} Participant \.{:} state [ p ] [ q ] . maxVBal \.{=} \.{-} 1}%
\@y{\@s{0}%
 free to pick its own value
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{27.51} \.{\lor} \E\, q
 \.{\in} Participant \.{:}}%
\@y{\@s{0}%
 \ensuremath{v} is the value with the highest \ensuremath{maxVBal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{46.82} \.{\land} state [
 p ] [ q ] . maxVVal \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{46.82} \.{\land} \A\, r
 \.{\in} Participant \.{:} state [ p ] [ q ] . maxVBal \.{\geq} state [ p ] [
 r ] . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{16.4} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ p ] [ p ] . maxVBal \.{=} b ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{130.84} {\bang} [ p ] [
 p ] . maxVVal\@s{0.37} \.{=} v ]}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{16.4} \.{\land} Send ( [
...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} chosen \.{\defeq} {\UNION}
 \{ ChosenP ( p ) \.{:} p \.{\in} Participant \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}} Consistency \.{\defeq}
 Cardinality ( chosen ) \.{\leq} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} Consistency}%
\@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 30 13:09:11 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
