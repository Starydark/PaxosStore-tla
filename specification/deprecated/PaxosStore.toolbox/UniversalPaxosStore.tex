...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{-} Message} types (\ensuremath{i.e}.,
 \ensuremath{\@w{Prepare}}, \ensuremath{\@w{Accept}}, \ensuremath{\@w{ACK}})
 are deleted.
\end{cpar}%
\end{lcom}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} Message \.{\defeq} [ from
 \.{:} Participant ,\, to \.{:} {\SUBSET} Participant ,\, state \.{:} [
 Participant \.{\rightarrow} State ] ]}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} state ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{state[p][q]}: the state of \ensuremath{q \.{\in} Participant}
 from the view of \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} msgs\@s{9.63}}%
\@y{\@s{0}%
 the set of messages that have been sent
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} vars \.{\defeq} {\langle}
 state ,\, msgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 state \.{\in} [ Participant \.{\rightarrow} [ Participant \.{\rightarrow}
 State ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 msgs \.{\subseteq} Message}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} state
 \.{=} [ p \.{\in} Participant \.{\mapsto} [ q \.{\in} Participant
 \.{\mapsto} InitState ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} msgs
 \.{=} \{ \}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} Prepare ( p ,\, b )
 \.{\defeq}}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} UpdateState ( q ,\, p ,\, pp
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} state \.{'} \.{=} [
 state {\EXCEPT}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{64.71} {\bang} [ q ] [ p
 ...
 maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{148.83} \.{\THEN} pp .
 maxVVal \.{\ELSE} @ ,\,}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{148.57} \.{\THEN} pp .
 maxVBal \.{\ELSE} @ ,\,\@s{4.1}}%
\@y{\@s{0}%
 make promise
}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} OnMessage ( q ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} \E\, m \.{\in} msgs
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{27.72} \.{\land} q
 \.{\in} m . to}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{27.72} \.{\land} \.{\LET}
 p \.{\defeq} m . from}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{38.83} \.{\IN}
 UpdateState ( q ,\, p ,\, m . state [ p ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{27.72} \.{\land} {\IF}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{50.98} \.{\lor} m . state
 [ q ] . maxVBal \.{<} state \.{'} [ q ] [ q ] . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{38.83} \.{\THEN} Send ( [
 from \.{\mapsto} q ,\, to \.{\mapsto} \{ m . from \} ,\, state \.{\mapsto}
 state \.{'} [ q ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{38.83} \.{\ELSE}
 {\UNCHANGED} msgs}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}} Accept ( p ,\, b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\land} b
 \.{\in} Bals ( p )\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{TODO}: delete it\.{?} to break ``client-restricted config''\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\land} \E\, Q
 \.{\in} Quorum \.{:} \A\, q \.{\in} Q \.{:} state [ p ] [ q ] . maxBal \.{=}
 b}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 \A\, q \.{\in} Participant \.{:} state [ p ] [ q ] . maxVBal \.{=} \.{-} 1}%
\@y{\@s{0}%
 free to pick its own value
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{27.51} \.{\lor} \E\, q
 \.{\in} Participant \.{:}}%
\@y{\@s{0}%
 \ensuremath{v} is the value with the highest \ensuremath{maxVBal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{46.82} \.{\land} state [
 p ] [ q ] . maxVVal \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{46.82} \.{\land} \A\, r
 ...
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{130.84} {\bang} [ p ] [
 p ] . maxVVal\@s{0.37} \.{=} v ]}%
...
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}} ChosenP ( p ) \.{\defeq}}%
\@y{\@s{0}%
 the set of values chosen by \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{16.4} \{ v \.{\in} Value
 \.{:} \E\, b \.{\in} Ballot \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{85.11} \E\, Q \.{\in}
 Quorum \.{:} \A\, q \.{\in} Q \.{:} \.{\land} state [ p ] [ q ] . maxVBal
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{202.26} \.{\land} state
 [ p ] [ q ] . maxVVal\@s{0.37} \.{=} v \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}} chosen \.{\defeq} {\UNION}
 \{ ChosenP ( p ) \.{:} p \.{\in} Participant \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} Consistency \.{\defeq}
 Cardinality ( chosen ) \.{\leq} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} Consistency}%
\@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 31 14:47:58 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
