...
\setboolean{shading}{true}
 ...
 {\MODULE} UniversalPaxosStoreWithVotes}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Extend \ensuremath{UniversalPaxosStore} with an explicit record of votes
 that have been accepted by participants.
 This is used to demonstrate that \ensuremath{UniversalPaxosStore} refines
 \ensuremath{EagerVoting}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\EXTENDS}
 UniversalPaxosStore ,\, TLC}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\VARIABLE} votes}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} TypeOKV \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} \.{\land} votes
 \.{\in} [ Participant \.{\rightarrow} {\SUBSET} ( Ballot \.{\times} Value )
 ]}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} InitV \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} \.{\land} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\land} votes
 \.{=} [ p \.{\in} Participant \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} PrepareV ( p ,\, b )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land} Prepare (
 p ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} votes}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} UpdateStateV ( q ,\, p ,\,
 pp ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land}
 UpdateState ( q ,\, p ,\, pp )}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} {\IF}
 state [ q ] [ q ] . maxBal \.{\leq} pp . maxVBal \.{\land} pp . maxVBal
 \.{\neq} \.{-} 1}%
\@y{\@s{0}%
 accept
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{27.51} \.{\THEN} votes
 \.{'} \.{=} [ votes {\EXCEPT} {\bang} [ q ] \.{=} @ \.{\cup} \{ {\langle} pp
 . maxVBal ,\, pp . maxVVal {\rangle} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{27.51} \.{\ELSE}
 {\UNCHANGED} votes}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} OnMessageV ( q ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \E\, m \.{\in} msgs
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{27.72} \.{\land} q
 \.{\in} m . to}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{27.72} \.{\land} \.{\LET}
 p \.{\defeq} m . from}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{38.83} \.{\IN}
 UpdateStateV ( q ,\, p ,\, m . state [ p ] )}%
\@y{\@s{0}%
 replacing \ensuremath{UpdateState
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{27.72} \.{\land} {\IF}
 \.{\lor} m . state [ q ] . maxBal \.{<} state \.{'} [ q ] [ q ] . maxBal}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{50.98} \.{\lor} m . state
 [ q ] . maxVBal \.{<} state \.{'} [ q ] [ q ] . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{38.83} \.{\THEN} Send ( [
 from \.{\mapsto} q ,\, to \.{\mapsto} \{ m . from \} ,\, state \.{\mapsto}
 state \.{'} [ q ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{38.83} \.{\ELSE}
 {\UNCHANGED} msgs}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} AcceptV ( p ,\, b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land}\@s{9.89}
 Accept ( p ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land}\@s{9.89}
 votes \.{'} \.{=} [ votes {\EXCEPT} {\bang} [ p ] \.{=} @ \.{\cup} \{
 {\langle} b ,\, v {\rangle} \} ]}%
\@y{\@s{0}%
 accept
}%
...
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} NextV \.{\defeq} \E\, p
 \.{\in} Participant \.{:} \.{\lor} OnMessageV ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{132.55} \.{\lor} \E\, b
 \.{\in} Ballot \.{:} \.{\lor} PrepareV ( p ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{204.93} \.{\lor} \E\, v
 \.{\in} Value \.{:} AcceptV ( p ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} SpecV\@s{1.08} \.{\defeq}
 InitV \.{\land} {\Box} [ NextV ]_{ {\langle} vars ,\, votes {\rangle}}}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{UniversalPaxosStore} refines \ensuremath{EagerVoting}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} maxBal \.{\defeq} [ p
 \.{\in} Participant \.{\mapsto} state [ p ] [ p ] . maxBal ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} EV \.{\defeq} {\INSTANCE}
 EagerVoting {\WITH} Acceptor \.{\leftarrow} Participant}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} {\THEOREM} SpecV
 \.{\implies} EV {\bang} Spec}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 14 16:06:44 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Wed}
 \ensuremath{Aug} 14 14:05:06 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
