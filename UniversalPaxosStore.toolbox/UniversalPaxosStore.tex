...
\setboolean{shading}{true}
 ...
 {\MODULE} UniversalPaxosStore}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
See [\ensuremath{PaxosStore}@\ensuremath{VLDB2017](https\.{:}\.{\slsl}www.vldb.org\.{/}pvldb\.{/}vol10\.{/}p1730\.{-}lin.pdf)} by \ensuremath{Tencent}.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
In this version (adopted from ``\ensuremath{PaxosStore.tla}''):
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{-} Message} types (\ensuremath{i.e}., ``Prepare'', ``Accept'',
 ``\ensuremath{ACK}'') are deleted.
 No state flags (such as ``Prepare'', ``Wait-Prepare'', ``Accept'',
 ``Wait-Accept''
 are needed.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} {\EXTENDS} Integers ,\,
 FiniteSets}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Max ( m ,\, n ) \.{\defeq}
 {\IF} m \.{>} n \.{\THEN} m \.{\ELSE} n}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Injective ( f ) \.{\defeq}
 \A\, a ,\, b \.{\in} {\DOMAIN} f \.{:} ( a \.{\neq} b ) \.{\implies} ( f [ a
 ] \.{\neq} f [ b ] )}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} {\CONSTANTS}}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} Participant
 ,\,\@s{4.1}}%
\@y{\@s{0}%
 the set of partipants
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} Value\@s{34.93}}%
\@y{\@s{0}%
 the set of possible input values for \ensuremath{Participant} to propose
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} None \.{\defeq} {\CHOOSE} b
 \.{:} b \.{\notin} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} NP \.{\defeq} Cardinality (
 Participant )}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Quorum \.{\defeq} \{ Q
 \.{\in} {\SUBSET} Participant \.{:} Cardinality ( Q ) \.{*} 2 \.{=} NP \.{+}
 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} {\ASSUME} QuorumAssumption
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Participant}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q1 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} Ballot\@s{4.66} \.{\defeq}
 Nat}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} PIndex \.{\defeq} {\CHOOSE}
 f \.{\in} [ Participant \.{\rightarrow} 1 \.{\dotdot} NP ] \.{:} Injective (
 f )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} Bals ( p ) \.{\defeq} \{ b
...
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} State \.{\defeq} [
 maxBal\@s{4.65} \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{41.61} maxVBal \.{:}
 Ballot \.{\cup} \{ \.{-} 1 \} ,\, maxVVal \.{:} Value \.{\cup} \{ None \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} InitState \.{\defeq} [
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} Message \.{\defeq} [ from
 \.{:} Participant ,\, to \.{:} {\SUBSET} Participant ,\, state \.{:} [
 Participant \.{\rightarrow} State ] ]}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} state ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{state[p][q]}: the state of \ensuremath{q \.{\in} Participant}
 from the view of \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} msgs\@s{9.63}}%
\@y{\@s{0}%
 the set of messages that have been sent
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} vars \.{\defeq} {\langle}
 state ,\, msgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 state \.{\in} [ Participant \.{\rightarrow} [ Participant \.{\rightarrow}
 State ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 msgs \.{\subseteq} Message}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} state
 \.{=} [ p \.{\in} Participant \.{\mapsto} [ q \.{\in} Participant
 \.{\mapsto} InitState ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} msgs
 \.{=} \{ \}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} Prepare ( p ,\, b )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land}\@s{6.34}
 state [ p ] [ p ] . maxBal \.{<} b}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} UpdateState ( q ,\, p ,\, pp
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} state \.{'} \.{=} [
 state {\EXCEPT}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{64.71} {\bang} [ q ] [ p
 ...
 maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{148.83} \.{\THEN} pp .
 maxVVal \.{\ELSE} @ ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{64.71} {\bang} [ q ] [ q
 ] . maxBal \.{=} Max ( @ ,\, pp . maxBal ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{64.71} {\bang} [ q ] [ q
 ] . maxVBal \.{=} {\IF} state [ q ] [ q ] . maxBal \.{\leq} pp . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{148.57} \.{\THEN} pp .
 maxVBal \.{\ELSE} @ ,\,\@s{4.1}}%
\@y{\@s{0}%
 make promise
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{64.71} {\bang} [ q ] [ q
 ] . maxVVal\@s{0.37} \.{=} {\IF} state [ q ] [ q ] . maxBal \.{\leq} pp .
 maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{148.57} \.{\THEN} pp .
 maxVVal \.{\ELSE} @ ]\@s{4.1}}%
\@y{\@s{0}%
 accept
}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} OnMessage ( q ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \E\, m \.{\in} msgs
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{27.72} \.{\land} q
 \.{\in} m . to}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{27.72} \.{\land} \.{\LET}
 p \.{\defeq} m . from}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{38.83} \.{\IN}
 UpdateState ( q ,\, p ,\, m . state [ p ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{27.72} \.{\land} {\IF}
 \.{\lor} m . state [ q ] . maxBal \.{<} state \.{'} [ q ] [ q ] . maxBal}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{50.98} \.{\lor} m . state
 [ q ] . maxVBal \.{<} state \.{'} [ q ] [ q ] . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{38.83} \.{\THEN} Send ( [
 from \.{\mapsto} q ,\, to \.{\mapsto} \{ m . from \} ,\, state \.{\mapsto}
 state \.{'} [ q ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{38.83} \.{\ELSE}
 {\UNCHANGED} msgs}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} Accept ( p ,\, b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\land} b
 \.{\in} Bals ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4} \.{\land} \E\, Q
 \.{\in} Quorum \.{:} \A\, q \.{\in} Q \.{:} state [ p ] [ q ] . maxBal \.{=}
 b}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 \A\, q \.{\in} Participant \.{:} state [ p ] [ q ] . maxVBal \.{=} \.{-} 1}%
\@y{\@s{0}%
 free to pick its own value
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{27.51} \.{\lor} \E\, q
 \.{\in} Participant \.{:}}%
\@y{\@s{0}%
 \ensuremath{v} is the value with the highest \ensuremath{maxVBal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{46.82} \.{\land} state [
 p ] [ q ] . maxVVal \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{46.82} \.{\land} \A\, r
 \.{\in} Participant \.{:} state [ p ] [ q ] . maxVBal \.{\geq} state [ p ] [
 r ] . maxVBal}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{16.4} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ p ] [ p ] . maxVBal \.{=} b ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{130.84} {\bang} [ p ] [
 p ] . maxVVal\@s{0.37} \.{=} v ]}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{16.4} \.{\land} Send ( [
 from \.{\mapsto} p ,\, to \.{\mapsto} Participant ,\, state \.{\mapsto}
 state \.{'} [ p ] ] )}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}} Next \.{\defeq} \E\, p
 \.{\in} Participant \.{:} \.{\lor} OnMessage ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{124.23} \.{\lor} \E\, b
 \.{\in} Ballot \.{:} \.{\lor} Prepare ( p ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{196.61} \.{\lor} \E\, v
 \.{\in} Value \.{:} Accept ( p ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{UniversalPaxosStore} satisfies the \ensuremath{Consistency}
 property.
\end{cpar}%
\end{lcom}%
...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}} chosen \.{\defeq} {\UNION}
 \{ ChosenP ( p ) \.{:} p \.{\in} Participant \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}} Consistency \.{\defeq}
 Cardinality ( chosen ) \.{\leq} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} Consistency}%
\@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 14 14:03:49 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
