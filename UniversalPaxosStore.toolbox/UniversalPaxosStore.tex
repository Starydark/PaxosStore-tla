...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 are deleted.
 No state flags (such as \ensuremath{\@w{Prepare}}, ``Wait-Prepare'',
 \ensuremath{\@w{Accept}}, ``Wait-Accept''
 are needed.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} {\EXTENDS} Integers ,\,
 FiniteSets}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Max ( m ,\, n ) \.{\defeq}
 {\IF} m \.{>} n \.{\THEN} m \.{\ELSE} n}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Injective ( f ) \.{\defeq}
 \A\, a ,\, b \.{\in} {\DOMAIN} f \.{:} ( a \.{\neq} b ) \.{\implies} ( f [ a
 ] \.{\neq} f [ b ] )}%
...
\@pvspace{8.0pt}%
 ...
 \.{:} b \.{\notin} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} NP \.{\defeq} Cardinality (
 Participant )}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Quorum \.{\defeq} \{ Q
...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} Ballot\@s{4.66} \.{\defeq}
 Nat}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} PIndex \.{\defeq} {\CHOOSE}
 f \.{\in} [ Participant \.{\rightarrow} 1 \.{\dotdot} NP ] \.{:} Injective (
 f )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Bals ( p ) \.{\defeq} \{ b
...
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} State \.{\defeq} [
 maxBal\@s{4.65} \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{41.61} maxVBal \.{:}
 Ballot \.{\cup} \{ \.{-} 1 \} ,\, maxVVal \.{:} Value \.{\cup} \{ None \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} InitState \.{\defeq} [
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} Message \.{\defeq} [ from
...
\@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}} OnMessage ( q ) \.{\defeq}}%
 ...
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{27.72} \.{\land} q
 \.{\in} m . to}%
...
\end{lcom}%
 ...
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4} \.{\land} b
 \.{\in} Bals ( p )}%
...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{130.84} {\bang} [ p ] [
 p ] . maxVVal\@s{0.37} \.{=} v ]}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{16.4} \.{\land} Send ( [
 from \.{\mapsto} p ,\, to \.{\mapsto} Participant ,\, state \.{\mapsto}
 state \.{'} [ p ] ] )}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}} Next \.{\defeq} \E\, p
 \.{\in} Participant \.{:} \.{\lor} OnMessage ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{124.23} \.{\lor} \E\, b
 \.{\in} Ballot \.{:} \.{\lor} Prepare ( p ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{196.61} \.{\lor} \E\, v
 \.{\in} Value \.{:} Accept ( p ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}} ChosenP ( p ) \.{\defeq}}%
\@y{\@s{0}%
 the set of values chosen by \ensuremath{p \.{\in} Participant
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{16.4} \{ v \.{\in} Value
 \.{:} \E\, b \.{\in} Ballot \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{85.11} \E\, Q \.{\in}
 Quorum \.{:} \A\, q \.{\in} Q \.{:} \.{\land} state [ p ] [ q ] . maxVBal
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{202.26} \.{\land} state
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 31 15:00:12 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
