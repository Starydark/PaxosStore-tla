...
\setboolean{shading}{true}
 ...
 {\MODULE} Consensus}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Sets ,\, TLAPS}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANT} Value\@s{4.1}}%
\@y{\@s{0}%
 the set of values that can be chosen
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\VARIABLE} chosen\@s{2.58}}%
\@y{\@s{0}%
 the set of values that have been chosen
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} Init\@s{4.12} \.{\defeq}
 chosen \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} \.{\land} chosen
 \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} \.{\land} \E\, v
 \.{\in} Value \.{:} chosen \.{'} \.{=} \{ v \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ chosen}}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Inv \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{15.15} \.{\land} chosen
 \.{\subseteq} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{15.15} \.{\land}
 IsFiniteSet ( chosen )}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{15.15} \.{\land}
 Cardinality ( chosen ) \.{\leq} 1}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} {\THEOREM} Invariance
 \.{\defeq} Spec \.{\implies} {\Box} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{8.2} {\BY}
 CardinalityZero ,\, SMT {\DEF} Init ,\, Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@pfstepnum{1}{2.}\  Inv
 \.{\land} [ Next ]_{ chosen} \.{\implies} Inv \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{8.2} {\BY} CardinalityOne
 ,\, SMT {\DEF} Next ,\, Inv}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@pfstepnum{1}{3.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{8.2}
 {\BY}\@pfstepnum{1}{1} ,\,\@pfstepnum{1}{2} ,\, PTL {\DEF} Spec}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}}\bottombar\@xx{}%
\end{document}
